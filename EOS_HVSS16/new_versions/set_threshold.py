...
'''
This script sets the nhit comparator threshold for one channel on one board
ARGUMENTS: <Slot#From0> <Channel#From0> <Voltage>
NOTE: The voltage argument supplied is inversely propotional to the threshold voltage set
'''
...
def main():
    if len(sys.argv)!=4:
        print("ERROR! 3 Arguments Required: <Slot#From0> <Channel#From0> <ThresholdVoltage>")
        sys.exit(1)
