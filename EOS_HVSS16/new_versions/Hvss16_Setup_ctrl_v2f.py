...
class create_widgets:
    def __init__(self, dataframe, defaultcanvas,tabdata = None):
        ...
        TabNames =  ['hvss0','hvss1','hvss2','hvss3','hvss4','hvss5','hvss6','hvss7','hvss8','hvss9']
        ...
        self.ChkButtonNames =['TpClkEn0','TpClkEn1','TpClkEn2','TpClkEn3','TpClkEn4','TpClkEn5','TpClkEn6','TpClkEn7','TpClkEn8','TpClkEn9']
        self.ChkButtonVars =['TpClkVar0','TpClkVar1','TpClkVar2','TpClkVar3','TpClkVar4','TpClkVar5','TpClkVar6','TpClkVar7','TpClkVar8','TpClkVar9']
        self.ChkButtons=[]
    ...
    def create_Checkbuttons(self):
        ...
        for cb in self.ChkButtons:
            ...
            if cbi in range(4,8):
                cb.grid(row = 24, column=cbi-4, sticky="w",padx=8,pady=4)
            if cbi in range(8,11):
                cb.grid(row = 25, column=cbi-8, sticky="w",padx=8,pady=4)
            ...
            for tbname in sorted(self.tabdata.keys()):
                ...
                if tbname == tabname:
                    for i,spinbox in enumerate(self.tabdata[tabname]):
                        ...
                        index = int(word[2])#Get hvssx index 'x'
                        print("GETNBDATA",tabname,i,index,spinbox.get())
                        if updateDac == True:
                            self.updateDAC(datalist,index)
            return datalist
